 ...
 */
@WebServlet(description = "사용자가 웹에서 *.up 을 했을 경우 이 서블릿이 먼저 응답을 해주도록 한다.", 
			urlPatterns = { "*.up" }, 
			initParams = { 
					 @WebInitParam(name = "propertyConfig", value = "C:/Users/user1/Documents/GitHub/KH1-SemiProject/ShoppingMall/WebContent/WEB-INF/Command.properties", description = "*.up 에 대한 클래스의 매핑파일")
					//@WebInitParam(name = "propertyConfig", value = "D:/JWA/myjsp/MyMVC/WebContent/WEB-INF/Command.properties", description = "*.up 에 대한 클래스의 매핑파일")
			})
