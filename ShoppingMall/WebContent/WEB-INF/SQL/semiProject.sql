...
,representative_img varchar2(200) not null -- 상품을 대표하는 이미지(리스트 및 상세에서 사용)
,image1 varchar2(200) -- 상품설명에 사용할 이미지1
,image2 varchar2(200) -- 상품설명에 사용할 이미지2
,image3 varchar2(200) -- 상품설명에 사용할 이미지3
,explain    varchar2(4000) -- 상품설명
