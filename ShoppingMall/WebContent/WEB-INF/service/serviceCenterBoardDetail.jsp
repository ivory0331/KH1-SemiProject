...
<style type="text/css">
   ...
   .otherList{
      list-style: none;
      border-top:solid 2px #6a3664;
      border-bottom:solid 2px #6a3664;
   }
...
<body>
   ...
   <div class="Mycontainer">
      ...
      <div class="section" align="center">
         <div class="contents">
            <div class="boardInfo" style="margin: 20px 0;">
               ...
               <c:forEach var="nvo" items="${nvoList}">
                  <c:if test="${nvo.notice_num == notice_num }">
                     <table class="table" style="border-top:solid 2px purple">
                        ...
                        <tr>
                           <td colspan="4" valign="top" style="border-bottom:solid 1px #795b8f;">
                        ...
                        <tr >
                           <td colspan="4" align="right"><span class="listBtn" onclick="goBoardList()">목록</span></td>
                        </tr>
                     </table>
                  </c:if>
                  </c:forEach>
                  <div class="other" align="left">
                     <ul class="otherList">
                        <c:forEach var="nvo" items="${nvoList}">
                           <c:if test="${nvo.notice_num > notice_num}">
                              <li class="prev" style="height:30px;padding:5px 0;">이전글<span style="margin:0 20px; ">I</span><span style="cursor: pointer;" onclick="javascript:location.href='<%=ctxPath%>/service/boardDetail.do?notice_num=${nvo.notice_num}'">${nvo.subject}</span></li>
                           </c:if>
                           <c:if test="${nvo.notice_num < notice_num}">
                              <li class="next" style="height:30px; padding:5px 0;">다음글<span style="margin:0 20px; ">I</span><span style="cursor: pointer;" onclick="javascript:location.href='<%=ctxPath%>/service/boardDetail.do?notice_num=${nvo.notice_num}'">${nvo.subject}</span></li>
                           </c:if>
                        </c:forEach>
                     </ul>
                  </div>
