								...
								<table>
									<tr>
										...
										<td class="memberCols2"><input type="text" name="userid"
											id="userid" placeholder="6자 이상의 영문 혹은 영문과 숫자를 조합" value=""
									...
									<tr>
										...
										<td class="memberCols2"><input type="password"
											name="passwd" id="passwd" placeholder="비밀번호를 입력해주세요" value=""
											maxlength="20" required />
											<p class="txt_guide" style="display: block;">
												<span class="txt txt_case1">10자 이상 입력</span><br /> <span
									...
									<tr>
										...
										<td class="memberCols2"><input type="password"
											name="passwd" id="passwd" placeholder="비밀번호를 한번 더 입력해주세요"
									...
									<tr>
										...
										<td class="memberCols2"><input type="text" name="name"
											...
											placeholder="고객님의 이름을 입력해주세요" required /> <span
											class="error name_error"></span></td>
									</tr>
									...
									<tr>
										...
										<td class="memberCols2"><input type="email" name="email"
											...
											placeholder="예: marketkurly@kurly.com" required /> <span
											class="error email_error"></span> <a
											href="javascript:chkEmail()"><span class="btnCheck">이메일
													중복확인</span></a></td>
									</tr>

									<tr>
										<td class="memberCols1">휴대폰*</td>
										<td class="memberCols2"><input type="tel" name="tel"
											id="tel" value="" maxlength="13" placeholder="숫자만 입력해주세요" />
											<a href="javascript:chkTel()"><span
												class="btnCheck btn_tel ">다른 번호 인증 </span></a> <input
											type="text" class="tel_confirm" name="tel_confirm"
											id="tel_confirm" value="" maxlength="6"> <a
											href="javascript:chkTel()"><span
												class="btnCheck btnCheck_tel ">인증번호 확인 </span></a>

											<p class="txt_guide" style="display: block;">
												<span class="txt txt_case1 receive">인증번호가 오지 않는다면,
													통신사 스팸 차단 서비스 혹은 휴대폰 번호 차단 여부를 확인해주세요. (마켓컬리 1644-1107)</span>
											</p></td>
									</tr>
								</table>
								...
								<table>
									<tr>
										...
										<td class="memberCols2"><input type="radio"
											class="gender" name="gender" value="m" id="male" /> <label
											for="male" class="text_position">남자</label> <input
											type="radio" class="gender" name="gender" value="w"
											id="female"> <label for="female"
											class="text_position">여자</label> <input type="radio"
											class="gender" name="gender" value="n" id="none" checked>
										...
										<td class="memberCols2">
											<div class="birth_day">
												<input type="text" name="birth_year" id="birth_year"
													value="" size="4" maxlength="4" placeholder="YYYY">
												<span class="bar">/</span> <input type="text"
													name="birth_month" id="birth_month" value="" size="2"
									...
									<td class="memberCols2">
										<div class="check_view">
											<input type="hidden" id="consentHidden" name="consent[1]"
												value=""> <label class="select_check check_agree">
												<input type="checkbox" name="hiddenCheck"
												class="styled-checkbox-black"> <span
												class="txt_checkbox no_pd">개인정보처리방침 <span
													class="sub_agree">(선택)</span></span>
											</label> <a href="#none" class="link btn_choice">&nbsp;&nbsp;
												약관보기 > </a>
										</div>
									</td>
								</tr>
